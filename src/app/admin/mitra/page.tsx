...
import { Handshake, Loader2, PlusCircle, Building, Trash2, X, CheckIcon, PencilIcon } from "lucide-react";
...
export default function MitraPage() {
    ...
    // Fetch mitras from dedicated mitras table
    ...
    // Start editing mitra
    const handleStartEdit = (mitra: Mitra) => {
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            const { error } = await supabase
                .from('mitras')
                .update({ name: editMitraName.trim() })
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        Mengelola daftar mitra kerjasama perusahaan
                    </p>
                </div>
